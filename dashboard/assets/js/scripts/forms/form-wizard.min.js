$((function () {
    "use strict";
    var e = document.querySelectorAll(".bs-stepper"), n = $(".select2"),
        i = document.querySelector(".vertical-wizard-example"),
        r = document.querySelector(".verticals-wizard-example"), t = document.querySelector(".modern-wizards-example"),
        o = document.querySelector(".modern-verticals-wizard-example");
    if (void 0 !== typeof e && null !== e) for (var l = 0; l < e.length; ++l) e[l].addEventListener("show.bs-stepper", (function (e) {
    ...
    if (void 0 !== typeof o && null !== o) {
        ...
        $(o).find(".btn-next").on("click", (function (e) {
            // u.next()
            $(this).parent().siblings("form").valid() ? u.next() : e.preventDefault()
